...
var s;
    ...
    if (showThumbs == true) {
        ...
        if (thumbUrl == "" && showNoImage == true) thumbUrl = 'https://lh3.googleusercontent.com/-w_iuFoXVsMw/UEdKoXlq-NI/AAAAAAAABBw/IGaAOx-l014/s125/noimage-ebloggertips.png';
    } //end ifposthumbs
    ...
    code = "";
        main = document.getElementById('ebloggertips_random');
        myDiv = document.createElement('div');
        myDiv.setAttribute("class", "ebloggertips_item_title");
...
myImage.style.boxShadow = "0 0 8px rgba(0, 0, 0, 0.3)";
        ...
        myLink.setAttribute("href", postUrl+"?utm_source=blog&utm_medium=gadget&utm_campaign=ebloggertips_random");
        myLink.setAttribute("target", "_top");
        myLink.setAttribute("title", postTitleOriginal);
        myLink.appendChild(myImage);

        myDiv = document.createElement('div');
        myDiv.setAttribute("class", "ebloggertips_item_thumb");
    ...
    try {
        ...
        if (showSummary == true) {
            myDiv = createDiv("ebloggertips_item_summary");
    ...
    myDiv =  createDiv("ebloggertips_item_meta");
    myDiv.style.clear="both";
...
href= href.substring(0,href.length-13)+"?utm_source=blog&utm_medium=gadget&utm_campaign=ebloggertips_random"+"#comment-form";
else if(href.indexOf("?utm_source=")==-1) href=href+"?utm_source=blog&utm_medium=gadget&utm_campaign=ebloggertips_random";
